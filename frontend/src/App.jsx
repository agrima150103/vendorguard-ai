  ...
  return (
    <div style={pageStyle}>
      ...
      >
        ...
        >
          Evidence-backed vendor assessment with prompt-injection
          defence, governed policy checks and a mandatory human
          decision.
        </p>
        ...
        >
          Every finding has evidence. Every action has permission.
          ...
          {[
            {
              ...
              text: "Extracts source-backed claims from vendor documents.",
              color: "#a78bfa",
            },
            {
              title: "Risk & Security Agent",
              text: "Detects prompt injection, contradictions and control gaps.",
              color: "#fbbf24",
            },
            {
              title: "Policy Agent via MCP",
              text: "Checks governed onboarding requirements through policy tools.",
              color: "#34d399",
            },
            {
              title: "Human Review",
              text: "The workflow pauses before any final onboarding decision.",
              color: "#60a5fa",
            },
          ].map((item, index) => (
            <div
